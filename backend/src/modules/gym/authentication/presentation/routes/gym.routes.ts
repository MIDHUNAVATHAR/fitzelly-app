...
// protected route
router.get(ROUTER_ENDPOINTS.GYM_AUTH.VERIFY_TOKEN, protect([ROLES.GYM]), GymController.verifyToken);
router.put("/profile", protect([ROLES.GYM]), GymController.updateProfile);
